...
const HeaderComponent = () => {
    ...
    <div className="nav">
      <ul className="nav flex-column">
          ...
          <li className="nav-item">
              <Link className="nav-link" to="/employees">数据管理</Link>
          </li>
          <li className="nav-item">
              <Link className="nav-link" to="/authoritys">算法管理</Link>
          </li>
          <li className="nav-item">
              <Link className="nav-link" to="/products">评价管理</Link>
          </li>
          <li className="nav-item">
              <Link className="nav-link" to="/orders">文件管理</Link>
          </li>
      </ul>
  </div>
  </div>
